                        ...
                        <form:form method="post" cssClass="row" action="${pageContext.servletContext.contextPath}/admin/reading" modelAttribute="searchForm" id="fetchAccount">
                            <div class="col-sm-4">
                                <div class="search-wrapper">
                                    ...
                                    <button id="filterButton" type="submit" class="btn btn-primary btn-search"><i class="fa fa-search fa-fw"></i> Search </button>
                                </div>
                            </div>
                        </form:form>
                        <hr/>
                        <div id="crt-mr-found" class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            ...
                                            <a id="filtertable"></a>
                                            <datatables:table cssClass="table table-striped" id="recent" filterPlaceholder="none" filterSelector="#filtertable" serverSide="true" url="${pageContext.servletContext.contextPath}/admin/reading/datatable-search" displayLength="3" dom="tp" >
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form:form modelAttribute="meterReadingForm" method="post" id="add-meterReading-form">
                                            ...
                                            <button style="margin-right: 30px;" class="btn btn-primary pull-right" type="submit">  Save  </button>
                                        </form:form>
                                    </div>
                                </div>
                            </div>
