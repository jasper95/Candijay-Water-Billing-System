                ...
                <fieldset>
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <datatables:table deferLoading="0" deferRender="true" cssClass="table table-striped" id="auditReading" filterPlaceholder="none" filterSelector="#filterButtonAuditTable" serverSide="true" url="${spring:mvcUrl('datatables-api#modified-readings').build()}" displayLength="3" dom="tpr" >
                                ...
                                <datatables:column title="Month" name="month" property="schedule.month" renderFunction="custom-rendering#month" sortable="false" cssCellClass="month"/>
                                <datatables:column title="Year" name="year" property="schedule.year" sortable="false" cssCellClass="year"/>
